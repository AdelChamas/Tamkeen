    ...
    <x-slot name="content">
        <div class="container" style="margin-top: 8rem;">
            ...
            <div class="social w-100 d-flex justify-content-center" >
                <a href="{{ route('google') }}" style="height: 60px; width: 200px; background-color: #ededed; padding: 5px; border-radius: 10px" class="mx-2 d-flex align-items-center justify-content-center">
